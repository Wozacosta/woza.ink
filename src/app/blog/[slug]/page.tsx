...
export default async function BlogPostPage({
  ...
  return (
    <main className="min-h-screen">
      ...
      <article className="max-w-3xl mx-auto px-8 pb-12">
        <div
      ...
      {(prev || next) && (
        <nav className="max-w-3xl mx-auto px-8 pb-24 mt-8 flex justify-between gap-8 border-t border-gray-200 dark:border-gray-700 pt-8">
          {prev ? (
