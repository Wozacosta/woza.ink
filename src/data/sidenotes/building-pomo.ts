...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      heading: "tldr-the-short-funky-version",
      type: "context",
      content:
    ...
    {
      heading: "the-problem-with-existing-apps",
      type: "source",
      content:
    ...
    {
      heading: "design-goals-the-short-manifesto",
      type: "context",
      content:
    ...
    {
      heading: "ux-decisions-i-stand-by-short-opinionated",
      type: "source",
      content:
    ...
    {
      heading: "the-hard-part-simplicity-is-discipline",
      type: "quote",
      content:
