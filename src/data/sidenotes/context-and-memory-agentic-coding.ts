...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      marker:
        "There's no database being queried. There's no long-term memory being updated",
      type: "context",
      content:
    ...
    {
      marker:
        "**Long conversations degrade.** As the window fills, earlier context gets less weight",
      type: "source",
      content:
    ...
    {
      marker:
        "Twenty sharp rules beats a hundred loose ones",
      type: "note",
      content:
    ...
    {
      marker:
        "Reference them explicitly when starting a session that needs them",
      type: "context",
      content:
    ...
    {
      marker:
        "They let a single session run for hours, accumulating context, and wonder why the quality degrades",
      type: "source",
      content:
    ...
    {
      marker:
        "**Explicit handoffs.** Before ending a long session, ask the agent to write a brief summary",
      type: "quote",
      content:
    ...
    {
      marker:
        "An agent is not a colleague who will remember your conversation tomorrow",
      type: "note",
      content:
