...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    ...
    {
      heading: "bluesky-at-protocol-in-practice",
      type: "note",
      content:
    ...
    {
      heading: "mastodon-the-fediverses-flagship",
      type: "context",
      content:
    ...
    {
      heading: "farcaster-crypto-native-social",
      type: "source",
      content:
    ...
    {
      heading: "nostr-cryptographic-minimalism",
      type: "note",
      content:
    ...
    {
      heading: "the-two-underlying-protocols",
      type: "source",
      content:
