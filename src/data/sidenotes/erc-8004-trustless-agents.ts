...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      marker:
        "Protocols like Google's A2A and Anthropic's MCP handle communication and tool use",
      type: "source",
      content:
    ...
    {
      marker:
        "How does it verify that agent is who it claims to be? How does it check its track record",
      type: "quote",
      content:
    ...
    {
      marker:
        "When an agent registers, it gets an NFT — a unique onchain identity",
      type: "context",
      content:
    ...
    {
      marker:
        "Every wallet, explorer, and indexer already knows how to handle them",
      type: "note",
      content:
    ...
    {
      marker:
        "it doesn't define a reputation *formula*. It doesn't say \"agents with score > X are trustworthy.\"",
      type: "counter",
      content:
    ...
    {
      marker:
        "the standard supports multiple validation approaches",
      type: "context",
      content:
    ...
    {
      marker:
        "The authors list includes Marco De Rossi (MetaMask/Consensys), Davide Crapis (Ethereum Foundation)",
      type: "source",
      content:
    ...
    {
      marker:
        "open agent networks need onchain trust primitives the same way the web needed DNS and TLS",
      type: "quote",
      content:
