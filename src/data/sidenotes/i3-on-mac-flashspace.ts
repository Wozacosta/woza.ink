...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      heading: "what-i3-actually-gives-you",
      type: "context",
      content:
    ...
    {
      heading: "flashspace-the-thing-that-clicked",
      type: "source",
      content:
    ...
    {
      heading: "why-snappiness-is-the-whole-point",
      type: "note",
      content:
    ...
    {
      heading: "for-tiling-pair-it-with-a-lightweight-tiler",
      type: "context",
      content:
