...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      heading: "why-matrix-actually-matters-and-why-you-should-care",
      type: "quote",
      content:
    ...
    {
      heading: "key-concepts-short-sweet",
      type: "context",
      content:
    ...
    {
      heading: "how-matrix-feels-different-not-just-technically-different",
      type: "counter",
      content:
    ...
    {
      heading: "security-privacy-what-matrix-protects-and-what-it-doesnt",
      type: "note",
      content:
    ...
    {
      heading: "bridges-the-secret-sauce-or-a-weird-duct-tape-moment",
      type: "context",
      content:
    ...
    {
      heading: "closing-why-this-matters-beyond-tech",
      type: "quote",
      content:
