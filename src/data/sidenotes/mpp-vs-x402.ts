...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      heading: "the-problem-both-are-solving",
      type: "context",
      content:
    ...
    {
      heading: "x402-http-402-finally-used",
      type: "source",
      content:
    ...
    {
      heading: "mpp-sessions-streaming-and-the-full-stripe-stack",
      type: "quote",
      content:
    ...
    {
      heading: "the-throughput-question",
      type: "counter",
      content:
