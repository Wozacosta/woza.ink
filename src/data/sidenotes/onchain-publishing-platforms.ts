...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      marker:
        "Mirror never achieved product-market fit beyond the crypto bubble",
      type: "context",
      content:
    ...
    {
      marker:
        "Discoverability is weak compared to Medium's algorithm",
      type: "counter",
      content:
    ...
    {
      marker:
        "The 3% platform fee on onchain memberships adds up",
      type: "note",
      content:
    ...
    {
      marker:
        "Justin Sun bought Steemit Inc. in 2020 and used exchange-held user funds to take over governance",
      type: "context",
      content:
    ...
    {
      marker:
        "bridging decentralized storage to the regular web",
      type: "note",
      content:
    ...
    {
      marker:
        "my writing exists permanently on a decentralized storage layer that no company can delete",
      type: "counter",
      content:
