...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      marker:
        "open-source (MIT licensed) and built to be model-agnostic",
      type: "context",
      content:
    ...
    {
      marker:
        "It ships from the company that makes Claude",
      type: "note",
      content:
    ...
    {
      marker:
        "The entire orchestration layer is on GitHub",
      type: "note",
      content:
    ...
    {
      marker:
        "**If you want to use non-Claude models:** OpenCode is the obvious choice",
      type: "context",
      content:
    ...
    {
      marker:
        "The more important investment is the context infrastructure",
      type: "counter",
      content:
