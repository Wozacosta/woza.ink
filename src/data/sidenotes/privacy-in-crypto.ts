...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      heading: "monero-privacy-by-default-at-the-protocol-level",
      type: "source",
      content:
    ...
    {
      heading: "zcash-optional-privacy-with-zero-knowledge-proofs",
      type: "context",
      content:
    ...
    {
      heading: "railgun-zk-privacy-on-ethereum-with-compliance-built-in",
      type: "quote",
      content:
    ...
    {
      heading: "why-blockchain-is-so-un-private-by-default",
      type: "context",
      content:
    ...
    {
      heading: "tornado-cash-and-what-happened-to-it",
      type: "source",
      content:
    ...
    {
      heading: "the-regulatory-reality",
      type: "counter",
      content:
    ...
    {
      heading: "p2p-exchanges-the-last-mile-problem",
      type: "note",
      content:
