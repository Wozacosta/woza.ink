...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    ...
    {
      marker:
        "They live in a project-level config file",
      type: "context",
      content:
    ...
    {
      marker:
        "The failure mode with rules is over-stuffing them",
      type: "source",
      content:
    ...
    {
      marker:
        "Commands are defined as markdown files with a prompt template",
      type: "source",
      content:
    ...
    {
      marker:
        "detailed instructions, workflows, domain knowledge, and reference material",
      type: "note",
      content:
    ...
    {
      marker:
        "Most developers treat AI as a conversation partner. The ones shipping faster treat it as a programmable system",
      type: "context",
      content:
