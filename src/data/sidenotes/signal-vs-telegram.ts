...
export const sidenotes: ArticleSidenotes = {
  ...
  notes: [
    {
      marker:
        "If privacy requires effort, fewer people get it",
      type: "quote",
      content:
    ...
    {
      marker:
        "Telegram holds the keys on the server side",
      type: "source",
      content:
    ...
    {
      marker:
        "Servers see everything for cloud chats",
      type: "quote",
      content:
    ...
    {
      marker:
        "a private company with a charismatic founder",
      type: "context",
      content:
    ...
    {
      marker:
        "fast sync across devices, cloud storage, rich features",
      type: "note",
      content:
    ...
    {
      marker:
        "Telegram has custom crypto history controversies and past questionable decisions",
      type: "counter",
      content:
    ...
    {
      marker:
        "releases on app stores often lag behind the public source",
      type: "quote",
      content:
